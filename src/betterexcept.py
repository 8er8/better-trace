...
def initialize(
    *,
    ...
    Example:
        ```
        >>> from betterexcept.betterexcept import initialize
        >>> initialize()
        >>> sayori
        -----------An error occurred-----------
...
def demo() -> None:
    ...
    Example:
        ```
        >>> from betterexcept import demo
        >>> demo()
        -----------An error occurred-----------
        File ".../betterexcept.py", line ..., in demo
...
def revert() -> None:
    ...
    Example:
        ```
        >>> from betterexcept import initialize, revert
        >>> initialize()
